...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "GSAK-&filters importeren…",
    "gsak_filter_import_dialog_title":       "GSAK-filters importeren",
    "gsak_filter_import_select_file_label":  "Kies GSAK's instellingendatabase (gsak.db3) of een back-up (.zip):",
    "gsak_filter_import_browse_title":       "gsak.db3 kiezen",
    "gsak_filter_import_file_filter":        "GSAK-instellingendatabase (gsak.db3 *.db3 *.zip);;Alle bestanden (*)",
    "gsak_filter_import_found":              "{count} opgeslagen filter(s) gevonden",
    "gsak_filter_import_select_all":         "Alles selecteren",
    "gsak_filter_import_select_none":        "Niets selecteren",
    "gsak_filter_import_search_placeholder": "Filters zoeken…",
    "gsak_filter_import_overwrite":          "Bestaande filterprofielen overschrijven",
    "gsak_filter_import_overwrite_tooltip":  "Uit: een bestaand profiel met dezelfde naam blijft staan en wordt als overgeslagen gemeld.",
    "gsak_filter_import_no_filters":         "Er konden geen opgeslagen GSAK-filters uit {name} gelezen worden.\n\n{error}\n\nOpgeslagen filters staan in GSAK's instellingendatabase gsak.db3 — niet in een cachedatabase (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} bevat geen opgeslagen filters.",
    "gsak_filter_import_running":            "{count} filter(s) importeren…",
    "gsak_filter_import_complete":           "Import voltooid.",
    "gsak_filter_import_written":            "Geschreven filterprofielen",
    "gsak_filter_import_skipped":            "Overgeslagen (bestaan al)",
    "gsak_filter_import_failed":             "Mislukt",
    "gsak_filter_import_stats_header":       "Migratiedekking",
    "gsak_filter_import_conditions":         "GSAK-voorwaarden",
    "gsak_filter_import_as_filters":         "… gemigreerd naar filters",
    "gsak_filter_import_as_sql":             "… gemigreerd naar Where-SQL",
    "gsak_filter_import_as_comments":        "… als SQL-commentaar achtergelaten",
    "gsak_filter_import_coverage":           "Dekking",
    "gsak_filter_import_full":               "volledig gemigreerd (100 %)",
    "gsak_filter_import_partial":            "deels gemigreerd",
    "gsak_filter_import_nothing":            "niets gemigreerd (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filter(s) hebben voorwaarden in commentaar staan:",
    "gsak_filter_import_left_in_comments":   "{count} in commentaar",
    "gsak_filter_import_where_hint":         "    Open zo'n filter via Filter instellen → Where om ze te zien en af te maken.",
    "gsak_filter_import_skipped_header":     "{count} filter(s) overgeslagen — een profiel met die naam bestaat al:",
    "gsak_filter_import_failed_header":      "{count} filter(s) konden niet omgezet worden:",
}
