...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Import GSAK &Filters…",
    "gsak_filter_import_dialog_title":       "Import GSAK Filters",
    "gsak_filter_import_select_file_label":  "Select GSAK's settings database (gsak.db3) or a backup (.zip):",
    "gsak_filter_import_browse_title":       "Select gsak.db3",
    "gsak_filter_import_file_filter":        "GSAK settings database (gsak.db3 *.db3 *.zip);;All files (*)",
    "gsak_filter_import_found":              "{count} saved filter(s) found",
    "gsak_filter_import_select_all":         "Select all",
    "gsak_filter_import_select_none":        "Select none",
    "gsak_filter_import_search_placeholder": "Search filters…",
    "gsak_filter_import_overwrite":          "Overwrite filter profiles that already exist",
    "gsak_filter_import_overwrite_tooltip":  "Off: an existing profile of the same name is kept and reported as skipped.",
    "gsak_filter_import_no_filters":         "No saved GSAK filters could be read from {name}.\n\n{error}\n\nSaved filters live in GSAK's settings database gsak.db3 — not in a cache database (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} holds no saved filters.",
    "gsak_filter_import_running":            "Importing {count} filter(s)…",
    "gsak_filter_import_complete":           "Import finished.",
    "gsak_filter_import_written":            "Filter profiles written",
    "gsak_filter_import_skipped":            "Skipped (already exist)",
    "gsak_filter_import_failed":             "Failed",
    "gsak_filter_import_stats_header":       "Migration coverage",
    "gsak_filter_import_conditions":         "GSAK conditions",
    "gsak_filter_import_as_filters":         "… migrated to filters",
    "gsak_filter_import_as_sql":             "… migrated to Where SQL",
    "gsak_filter_import_as_comments":        "… left as SQL comments",
    "gsak_filter_import_coverage":           "Coverage",
    "gsak_filter_import_full":               "fully migrated (100 %)",
    "gsak_filter_import_partial":            "partly migrated",
    "gsak_filter_import_nothing":            "nothing migrated (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filter(s) have conditions left in comments:",
    "gsak_filter_import_left_in_comments":   "{count} in comments",
    "gsak_filter_import_where_hint":         "    Open such a filter under Set filter → Where to see and finish them.",
    "gsak_filter_import_skipped_header":     "{count} filter(s) skipped — a profile of that name already exists:",
    "gsak_filter_import_failed_header":      "{count} filter(s) could not be converted:",
}
