...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Importovat &filtry z GSAK…",
    "gsak_filter_import_dialog_title":       "Import filtrů z GSAK",
    "gsak_filter_import_select_file_label":  "Vyberte databázi nastavení GSAK (gsak.db3) nebo zálohu (.zip):",
    "gsak_filter_import_browse_title":       "Vybrat gsak.db3",
    "gsak_filter_import_file_filter":        "Databáze nastavení GSAK (gsak.db3 *.db3 *.zip);;Všechny soubory (*)",
    "gsak_filter_import_found":              "Nalezeno {count} uložených filtrů",
    "gsak_filter_import_select_all":         "Vybrat vše",
    "gsak_filter_import_select_none":        "Zrušit výběr",
    "gsak_filter_import_search_placeholder": "Hledat filtry…",
    "gsak_filter_import_overwrite":          "Přepsat existující profily filtrů",
    "gsak_filter_import_overwrite_tooltip":  "Vypnuto: existující profil se stejným názvem zůstane a bude hlášen jako přeskočený.",
    "gsak_filter_import_no_filters":         "Ze souboru {name} se nepodařilo načíst uložené filtry GSAK.\n\n{error}\n\nUložené filtry jsou v databázi nastavení gsak.db3 — ne v databázi kešek (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} neobsahuje žádné uložené filtry.",
    "gsak_filter_import_running":            "Importuji {count} filtrů…",
    "gsak_filter_import_complete":           "Import dokončen.",
    "gsak_filter_import_written":            "Zapsané profily filtrů",
    "gsak_filter_import_skipped":            "Přeskočeno (již existují)",
    "gsak_filter_import_failed":             "Selhalo",
    "gsak_filter_import_stats_header":       "Pokrytí migrace",
    "gsak_filter_import_conditions":         "Podmínky GSAK",
    "gsak_filter_import_as_filters":         "… převedeno na filtry",
    "gsak_filter_import_as_sql":             "… převedeno na SQL ve Where",
    "gsak_filter_import_as_comments":        "… ponecháno jako SQL komentář",
    "gsak_filter_import_coverage":           "Pokrytí",
    "gsak_filter_import_full":               "plně převedeno (100 %)",
    "gsak_filter_import_partial":            "částečně převedeno",
    "gsak_filter_import_nothing":            "nepřevedeno nic (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filtrů má podmínky ponechané v komentáři:",
    "gsak_filter_import_left_in_comments":   "{count} v komentáři",
    "gsak_filter_import_where_hint":         "    Otevřete takový filtr v Nastavit filtr → Where a dokončete je tam.",
    "gsak_filter_import_skipped_header":     "{count} filtrů přeskočeno — profil s tímto názvem už existuje:",
    "gsak_filter_import_failed_header":      "{count} filtrů se nepodařilo převést:",
}
