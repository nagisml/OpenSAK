...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Importar &filtros do GSAK…",
    "gsak_filter_import_dialog_title":       "Importar filtros do GSAK",
    "gsak_filter_import_select_file_label":  "Escolha a base de definições do GSAK (gsak.db3) ou uma cópia (.zip):",
    "gsak_filter_import_browse_title":       "Escolher gsak.db3",
    "gsak_filter_import_file_filter":        "Base de definições do GSAK (gsak.db3 *.db3 *.zip);;Todos os ficheiros (*)",
    "gsak_filter_import_found":              "{count} filtro(s) guardado(s) encontrado(s)",
    "gsak_filter_import_select_all":         "Selecionar tudo",
    "gsak_filter_import_select_none":        "Não selecionar nada",
    "gsak_filter_import_search_placeholder": "Procurar filtros…",
    "gsak_filter_import_overwrite":          "Substituir perfis de filtro já existentes",
    "gsak_filter_import_overwrite_tooltip":  "Desligado: um perfil existente com o mesmo nome é mantido e indicado como ignorado.",
    "gsak_filter_import_no_filters":         "Não foi possível ler filtros guardados do GSAK em {name}.\n\n{error}\n\nOs filtros guardados estão na base de definições gsak.db3 — não numa base de caches (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} não contém filtros guardados.",
    "gsak_filter_import_running":            "A importar {count} filtro(s)…",
    "gsak_filter_import_complete":           "Importação concluída.",
    "gsak_filter_import_written":            "Perfis de filtro escritos",
    "gsak_filter_import_skipped":            "Ignorados (já existem)",
    "gsak_filter_import_failed":             "Falharam",
    "gsak_filter_import_stats_header":       "Cobertura da migração",
    "gsak_filter_import_conditions":         "Condições do GSAK",
    "gsak_filter_import_as_filters":         "… migradas para filtros",
    "gsak_filter_import_as_sql":             "… migradas para SQL do Where",
    "gsak_filter_import_as_comments":        "… deixadas como comentários SQL",
    "gsak_filter_import_coverage":           "Cobertura",
    "gsak_filter_import_full":               "totalmente migrados (100 %)",
    "gsak_filter_import_partial":            "parcialmente migrados",
    "gsak_filter_import_nothing":            "nada migrado (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filtro(s) têm condições em comentário:",
    "gsak_filter_import_left_in_comments":   "{count} em comentário",
    "gsak_filter_import_where_hint":         "    Abra esse filtro em Definir filtro → Where para as ver e terminar.",
    "gsak_filter_import_skipped_header":     "{count} filtro(s) ignorado(s) — já existe um perfil com esse nome:",
    "gsak_filter_import_failed_header":      "{count} filtro(s) não puderam ser convertidos:",
}
