...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Importer les &filtres GSAK…",
    "gsak_filter_import_dialog_title":       "Importer les filtres GSAK",
    "gsak_filter_import_select_file_label":  "Choisissez la base de configuration GSAK (gsak.db3) ou une sauvegarde (.zip) :",
    "gsak_filter_import_browse_title":       "Choisir gsak.db3",
    "gsak_filter_import_file_filter":        "Base de configuration GSAK (gsak.db3 *.db3 *.zip);;Tous les fichiers (*)",
    "gsak_filter_import_found":              "{count} filtre(s) enregistré(s) trouvé(s)",
    "gsak_filter_import_select_all":         "Tout sélectionner",
    "gsak_filter_import_select_none":        "Tout désélectionner",
    "gsak_filter_import_search_placeholder": "Rechercher des filtres…",
    "gsak_filter_import_overwrite":          "Écraser les profils de filtre existants",
    "gsak_filter_import_overwrite_tooltip":  "Décoché : un profil existant du même nom est conservé et signalé comme ignoré.",
    "gsak_filter_import_no_filters":         "Impossible de lire des filtres GSAK enregistrés dans {name}.\n\n{error}\n\nLes filtres enregistrés se trouvent dans la base de configuration gsak.db3 — pas dans une base de caches (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} ne contient aucun filtre enregistré.",
    "gsak_filter_import_running":            "Import de {count} filtre(s)…",
    "gsak_filter_import_complete":           "Import terminé.",
    "gsak_filter_import_written":            "Profils de filtre écrits",
    "gsak_filter_import_skipped":            "Ignorés (déjà existants)",
    "gsak_filter_import_failed":             "Échecs",
    "gsak_filter_import_stats_header":       "Couverture de la migration",
    "gsak_filter_import_conditions":         "Conditions GSAK",
    "gsak_filter_import_as_filters":         "… migrées en filtres",
    "gsak_filter_import_as_sql":             "… migrées en SQL Where",
    "gsak_filter_import_as_comments":        "… laissées en commentaires SQL",
    "gsak_filter_import_coverage":           "Couverture",
    "gsak_filter_import_full":               "entièrement migrés (100 %)",
    "gsak_filter_import_partial":            "partiellement migrés",
    "gsak_filter_import_nothing":            "rien de migré (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filtre(s) ont des conditions restées en commentaire :",
    "gsak_filter_import_left_in_comments":   "{count} en commentaire",
    "gsak_filter_import_where_hint":         "    Ouvrez un tel filtre via Définir le filtre → Where pour les voir et les finir.",
    "gsak_filter_import_skipped_header":     "{count} filtre(s) ignoré(s) — un profil de ce nom existe déjà :",
    "gsak_filter_import_failed_header":      "{count} filtre(s) n'ont pas pu être convertis :",
}
