...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "GSAK-&Filter importieren…",
    "gsak_filter_import_dialog_title":       "GSAK-Filter importieren",
    "gsak_filter_import_select_file_label":  "GSAK-Einstellungsdatenbank (gsak.db3) oder Backup (.zip) auswählen:",
    "gsak_filter_import_browse_title":       "gsak.db3 auswählen",
    "gsak_filter_import_file_filter":        "GSAK-Einstellungsdatenbank (gsak.db3 *.db3 *.zip);;Alle Dateien (*)",
    "gsak_filter_import_found":              "{count} gespeicherte(r) Filter gefunden",
    "gsak_filter_import_select_all":         "Alle auswählen",
    "gsak_filter_import_select_none":        "Keine auswählen",
    "gsak_filter_import_search_placeholder": "Filter suchen…",
    "gsak_filter_import_overwrite":          "Bereits vorhandene Filterprofile überschreiben",
    "gsak_filter_import_overwrite_tooltip":  "Aus: ein vorhandenes Profil gleichen Namens bleibt erhalten und wird als übersprungen gemeldet.",
    "gsak_filter_import_no_filters":         "Aus {name} konnten keine gespeicherten GSAK-Filter gelesen werden.\n\n{error}\n\nGespeicherte Filter liegen in der GSAK-Einstellungsdatenbank gsak.db3 — nicht in einer Cache-Datenbank (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} enthält keine gespeicherten Filter.",
    "gsak_filter_import_running":            "{count} Filter werden importiert…",
    "gsak_filter_import_complete":           "Import abgeschlossen.",
    "gsak_filter_import_written":            "Geschriebene Filterprofile",
    "gsak_filter_import_skipped":            "Übersprungen (schon vorhanden)",
    "gsak_filter_import_failed":             "Fehlgeschlagen",
    "gsak_filter_import_stats_header":       "Migrationsabdeckung",
    "gsak_filter_import_conditions":         "GSAK-Bedingungen",
    "gsak_filter_import_as_filters":         "… in Filter migriert",
    "gsak_filter_import_as_sql":             "… in Where-SQL migriert",
    "gsak_filter_import_as_comments":        "… als SQL-Kommentar hinterlegt",
    "gsak_filter_import_coverage":           "Abdeckung",
    "gsak_filter_import_full":               "vollständig migriert (100 %)",
    "gsak_filter_import_partial":            "teilweise migriert",
    "gsak_filter_import_nothing":            "nichts migriert (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} Filter haben Bedingungen im Kommentar:",
    "gsak_filter_import_left_in_comments":   "{count} im Kommentar",
    "gsak_filter_import_where_hint":         "    Solche Filter unter Filter setzen → Where öffnen und dort fertigstellen.",
    "gsak_filter_import_skipped_header":     "{count} Filter übersprungen — ein Profil dieses Namens existiert bereits:",
    "gsak_filter_import_failed_header":      "{count} Filter konnten nicht umgewandelt werden:",
}
