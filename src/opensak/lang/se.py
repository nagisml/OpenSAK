...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Importera GSAK-&filter…",
    "gsak_filter_import_dialog_title":       "Importera GSAK-filter",
    "gsak_filter_import_select_file_label":  "Välj GSAK:s inställningsdatabas (gsak.db3) eller en säkerhetskopia (.zip):",
    "gsak_filter_import_browse_title":       "Välj gsak.db3",
    "gsak_filter_import_file_filter":        "GSAK-inställningsdatabas (gsak.db3 *.db3 *.zip);;Alla filer (*)",
    "gsak_filter_import_found":              "{count} sparade filter hittades",
    "gsak_filter_import_select_all":         "Markera alla",
    "gsak_filter_import_select_none":        "Avmarkera alla",
    "gsak_filter_import_search_placeholder": "Sök filter…",
    "gsak_filter_import_overwrite":          "Skriv över filterprofiler som redan finns",
    "gsak_filter_import_overwrite_tooltip":  "Av: en befintlig profil med samma namn behålls och rapporteras som överhoppad.",
    "gsak_filter_import_no_filters":         "Det gick inte att läsa sparade GSAK-filter från {name}.\n\n{error}\n\nSparade filter ligger i GSAK:s inställningsdatabas gsak.db3 — inte i en cachedatabas (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} innehåller inga sparade filter.",
    "gsak_filter_import_running":            "Importerar {count} filter…",
    "gsak_filter_import_complete":           "Importen klar.",
    "gsak_filter_import_written":            "Skrivna filterprofiler",
    "gsak_filter_import_skipped":            "Överhoppade (finns redan)",
    "gsak_filter_import_failed":             "Misslyckades",
    "gsak_filter_import_stats_header":       "Migreringstäckning",
    "gsak_filter_import_conditions":         "GSAK-villkor",
    "gsak_filter_import_as_filters":         "… migrerade till filter",
    "gsak_filter_import_as_sql":             "… migrerade till Where-SQL",
    "gsak_filter_import_as_comments":        "… kvar som SQL-kommentarer",
    "gsak_filter_import_coverage":           "Täckning",
    "gsak_filter_import_full":               "helt migrerade (100 %)",
    "gsak_filter_import_partial":            "delvis migrerade",
    "gsak_filter_import_nothing":            "inget migrerat (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filter har villkor kvar i kommentarer:",
    "gsak_filter_import_left_in_comments":   "{count} i kommentarer",
    "gsak_filter_import_where_hint":         "    Öppna ett sådant filter under Ange filter → Where för att se och slutföra dem.",
    "gsak_filter_import_skipped_header":     "{count} filter överhoppade — en profil med det namnet finns redan:",
    "gsak_filter_import_failed_header":      "{count} filter kunde inte konverteras:",
}
