...
STRINGS: dict[str, str] = {
    ...
    # ── GSAK filter import ────────────────────────────────────────────────────
    "action_gsak_filter_import":             "Importér GSAK-&filtre…",
    "gsak_filter_import_dialog_title":       "Importér GSAK-filtre",
    "gsak_filter_import_select_file_label":  "Vælg GSAK's indstillingsdatabase (gsak.db3) eller en backup (.zip):",
    "gsak_filter_import_browse_title":       "Vælg gsak.db3",
    "gsak_filter_import_file_filter":        "GSAK-indstillingsdatabase (gsak.db3 *.db3 *.zip);;Alle filer (*)",
    "gsak_filter_import_found":              "{count} gemte filtre fundet",
    "gsak_filter_import_select_all":         "Vælg alle",
    "gsak_filter_import_select_none":        "Vælg ingen",
    "gsak_filter_import_search_placeholder": "Søg i filtre…",
    "gsak_filter_import_overwrite":          "Overskriv filterprofiler der allerede findes",
    "gsak_filter_import_overwrite_tooltip":  "Fra: en eksisterende profil med samme navn bevares og rapporteres som sprunget over.",
    "gsak_filter_import_no_filters":         "Der kunne ikke læses gemte GSAK-filtre fra {name}.\n\n{error}\n\nGemte filtre ligger i GSAK's indstillingsdatabase gsak.db3 — ikke i en cache-database (sqlite.db3).",
    "gsak_filter_import_none_found":         "{name} indeholder ingen gemte filtre.",
    "gsak_filter_import_running":            "Importerer {count} filtre…",
    "gsak_filter_import_complete":           "Import færdig.",
    "gsak_filter_import_written":            "Skrevne filterprofiler",
    "gsak_filter_import_skipped":            "Sprunget over (findes i forvejen)",
    "gsak_filter_import_failed":             "Mislykkedes",
    "gsak_filter_import_stats_header":       "Migreringsdækning",
    "gsak_filter_import_conditions":         "GSAK-betingelser",
    "gsak_filter_import_as_filters":         "… migreret til filtre",
    "gsak_filter_import_as_sql":             "… migreret til Where-SQL",
    "gsak_filter_import_as_comments":        "… efterladt som SQL-kommentarer",
    "gsak_filter_import_coverage":           "Dækning",
    "gsak_filter_import_full":               "fuldt migreret (100 %)",
    "gsak_filter_import_partial":            "delvist migreret",
    "gsak_filter_import_nothing":            "intet migreret (0 %)",
    "gsak_filter_import_incomplete_header":  "{count} filtre har betingelser tilbage i kommentarer:",
    "gsak_filter_import_left_in_comments":   "{count} i kommentarer",
    "gsak_filter_import_where_hint":         "    Åbn et sådant filter under Sæt filter → Where for at se og færdiggøre dem.",
    "gsak_filter_import_skipped_header":     "{count} filtre sprunget over — en profil med det navn findes allerede:",
    "gsak_filter_import_failed_header":      "{count} filtre kunne ikke konverteres:",
}
